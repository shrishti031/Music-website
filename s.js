...
const songs=[
    {
        id:1,
        songName:`SubhanAllah<br>
        <div class="subtitle">YE Jawani hai Dewni</div>`,
        poster:"1.jpg"
    },
    {
        id:2,
        songName:`Jaan Neshar<br>
        <div class="subtitle">KedarNath</div>`,
        poster:"2.jpg"
    },
    {
        id:3,
        songName:`Aasique aa gye<br>
        <div class="subtitle">Radhey Shyam</div>`,
        poster:"3.jpg"
    },
    {
        id:4,
        songName:`Rabb Manya<br>
        <div class="subtitle">Koi Jane na</div>`,
        poster:"4.jpg"
    },
    {
        id:5,
        songName:`Chalo ab sach Batao <br>
        <div class="subtitle">Stebin ben</div>`,
        poster:"5.jpg"
    },
    {
        id:6,
        songName:`Kali Kali Julfe<br>
        <div class="subtitle">Madhur Sharma</div>`,
        poster:"6.jpg"
    },
    {
        id:7,
    ...
    },
    {
        ...
        <div class="subtitle">Ap Dillion</div>`,
        poster:"19.jpg"
    },
    {
        id:20,
        songName:`Tumhe kitna pyaar<br>
        <div class="subtitle">Bawal</div>`,
        poster:"20.jpg"
    },
...
const repeatmusic=()=>{
    ...
    poster.src=`${index}.jpg`;
    music.play();
    mplay.classList.remove('bi-play-circle--fill');
    mplay.classList.add('bi-pause-circle-fill');
    download.href=`audio/${index}.mp3`;
    let songtitles=songs.filter((els)=>{
         return els.id==index;
    });
